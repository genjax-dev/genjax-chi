...
def model(key, object_model_cloud, h, w, fx_fy, cx_cy, r, outlier_prob):
    key, pos = genjax.trace("pos", genjax.Uniform)(
        key, (jnp.array([-10.0, -10.0, -100.0]), jnp.array([10.0, 10.0, 100.0]))
    )
    pose = jnp.array(
        [
            [1.0, 0.0, 0.0, pos[0]],
