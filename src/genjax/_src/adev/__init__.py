...
"""This module provides an implementation of [ADEV: Sound Automatic
Differentiation of Expected
Values](https://dl.acm.org/doi/abs/10.1145/3571198), an AD algorithm which
derivates forward mode derivative estimators for programs which denote
expectations.
