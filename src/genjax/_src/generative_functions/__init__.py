...
* The [`distributions`](./distributions/) module provides generative function wrappers for standard distributions from TensorFlow Probability Distributions (`tfd`), as well as custom distributions. All of the distributions exported from this module are `GFI`.
